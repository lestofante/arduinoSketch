...
/* defines for customisation of sd/mmc port access */
    ...
    #define configure_pin_mosi() DDRB |= (1 << 3)
    #define configure_pin_sck() DDRB |= (1 << 5)
    #define configure_pin_ss() DDRB |= (1 << 2)
    #define configure_pin_miso() DDRB &= ~(1 << 4)

    #define select_card() PORTB &= ~(1 << 2)
    #define unselect_card() PORTB |= (1 << 2)
#elif defined(__AVR_ATmega16__) || \
      defined(__AVR_ATmega32__)
    #define configure_pin_mosi() DDRB |= (1 << 5)
    #define configure_pin_sck() DDRB |= (1 << 7)
    #define configure_pin_ss() DDRB |= (1 << 4)
    #define configure_pin_miso() DDRB &= ~(1 << 6)

    #define select_card() PORTB &= ~(1 << 4)
    #define unselect_card() PORTB |= (1 << 4)
    ...
    #define select_card() PORTB &= ~(1 << 0)
    #define unselect_card() PORTB |= (1 << 0)
#else
